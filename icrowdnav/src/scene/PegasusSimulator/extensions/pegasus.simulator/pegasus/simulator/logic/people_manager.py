...
class PeopleManager:
    ...
    def rebuild_nav_mesh(height=1.5, radius=0.5, auto_rebake_on_changes=False, auto_rebake_delay_seconds=4, exclude_rigid_bodies=False, view_nav_mesh=True, dynamic_avoidance_enabled=True, navmesh_enabled=True):
        """
